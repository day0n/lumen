...
import { IconBolt, IconChartBar, IconSearch, IconSparkles, IconTargetArrow } from '@tabler/icons-react';
      ...
      {open ? (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-xl overflow-hidden rounded-2xl bg-[#121416]/96 ring-1 ring-white/[0.1] shadow-[0_24px_80px_rgba(0,0,0,0.55)]"
